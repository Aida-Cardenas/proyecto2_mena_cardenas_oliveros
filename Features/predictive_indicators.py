...
class PredictiveIndicators:
    ...
    visualizar el éxito probable de videojuegos por género
    """
    ...
    def calculate_success_indicators_by_genre(self):
        """Calcular indicadores de éxito por género"""
        ...
        # Categorizar géneros por potencial de éxito
    ...
    def _find_successful_combinations(self, results_df):
        """Encontrar combinaciones exitosas de género-plataforma"""
    ...
    def _analyze_temporal_trends(self, results_df):
        ...
        # Solo años con suficientes datos
    ...
    def _generate_investment_recommendations(self, genre_indicators):
        ...
        # Ordenar por potencial vs saturación
    ...
    def create_visualizations(self, genre_indicators, platform_indicators, results_df):
        ...
        # 1. Probabilidad de éxito por género
        ax1 = axes[0, 0]
        ...
        # 4. Relación entre ventas reales y probabilidad predicha
        ax4 = axes[1, 1]
...
"""
    ...
    def run_complete_analysis(self):
        """Ejecutar análisis completo de indicadores predictivos"""
